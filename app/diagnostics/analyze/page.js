...
//       // 🔒 HARD SAFETY (never allow empty AI output)
//       setResult({
//         summary: json.summary || "Clinical analysis completed.",
//         conditions: Array.isArray(json.conditions) && json.conditions.length > 0
//           ? json.conditions
...
//               name: "General Health Status",
//               severity: "Low",
//               justification: "No significant clinical risk markers detected."
//             }],
//         evidence: Array.isArray(json.evidence) && json.evidence.length > 0
//           ? json.evidence
//           : ["No abnormal findings detected in the document."]
//       });
//     } catch {
//       setError("Unable to analyze document");
//     } finally {
...
//       {!user && (
//         <p className="text-red-400 mb-4">
//           Please login to analyze documents.
//         </p>
//       )}
