          ...
          <div className='w-full grid grid-cols-4 text-center divide-x px-6'>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <span className='font-semibold text-sm text-gray-800'>
                Squeeze fresh lemons into clean water.
              </span>
            </div>
            ...
            <div className='flex flex-col justify-center'>
              ...
              <span className='font-semibold text-lg text-teal-700'>Digestion & Immunity</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-10 py-16 grid grid-cols-3 gap-16">
        ...
        <div className="col-span-2">
          ...
          <ol className="list-decimal ml-6 text-gray-700 space-y-3 leading-relaxed">
            ...
            <li>Mix well without adding sugar.</li>
            <li>Add honey or rock salt only if required.</li>
            <li>Consume fresh for best benefits.</li>
          </ol>
        ...
        <div className="bg-gray-50 border rounded-md p-6 h-fit">
          ...
          <div className="divide-y text-gray-700">
            <div className="flex justify-between py-2"><span>Calories</span><span>30</span></div>
            <div className="flex justify-between py-2"><span>Protein</span><span>1 g</span></div>
            <div className="flex justify-between py-2"><span>Carbohydrates</span><span>9 g</span></div>
            <div className="flex justify-between py-2"><span>Fat</span><span>0 g</span></div>
            <div className="flex justify-between py-2"><span>Fiber</span><span>1 g</span></div>
            <div className="flex justify-between py-2"><span>Vitamin C</span><span>40 mg</span></div>
          </div>
        </div>
      ...
      <section className="w-full bg-[#083c47] text-white px-10 py-10 mt-20">
        ...
        <div className="max-w-6xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm">
            ...
            intelligence to help users make informed wellness decisions.
          </p>
